...
class Star1(Player):
    ...
    def __init__(self, currentPlayer = 0, Depth = 0, MaxDepth = 1, Alpha = -float('inf'), Beta = float('inf'), Chance = None, Init=False):
        super().__init__()
    ...
    def ClonePlayer(self):
        Clone = Star1(self.currentPlayer, self.Depth, self.MaxDepth, self.Alpha, self.Beta, self.Chance, self.Init)
        return Clone
