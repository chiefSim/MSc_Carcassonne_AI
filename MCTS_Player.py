...
class MCTSPlayer(Player):
    ...
    def __init__(self, iterations = 10, timeLimit = 3, isTimeLimited = False, c_param = 9, logs=False):
        super().__init__()
    ...
    def MCTS_IterationLimit(self, root_node, root_state):
        ...
        endTime = time.time()
        print(f'(MCTS_Vanilla) TimeTaken: {round(endTime - startTime,3)} secs, Time:{time.strftime("%H:%M:%S", time.localtime())}')
